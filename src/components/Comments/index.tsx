...
const Comments: React.FC = () => {
  ...
  return (
    <Container>
      ...
      >
        <Alert severity="success">Comment deleted!</Alert>
      </Snackbar>
      <Snackbar
      ...
      >
        <Alert severity="success">Comment published!</Alert>
      </Snackbar>
      {!post ? (
            ...
            <OriginalPost>
              <div>
                ...
                <p style={{ color: '#636363' }}>
                  {post.users.username.length > 45
                    ? post.users.username.substring(0, 45) + '...'
                    : post.users.username}
                </p>
              </div>
              <div>
                <ImgContainer>
                  <Cookie src={cookie} style={{ marginRight: '10px' }} />
          ...
          <CommentView>
            ...
            {comment.map((comment) => (
              <Comment key={comment.id}>
                <Header>
                  <h4>
                    {comment.users.username.length > 65
                      ? comment.users.username.substring(0, 65) + '...'
